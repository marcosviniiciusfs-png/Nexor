...
webhooks succeed, queue a JSON copy of the lead for GitHub export. A scheduled
GitHub Action pulls the queue and commits the JSON files to this repository.
After those steps succeed, it sends the same Lead event to Meta Conversions API.
...
```bash
wrangler secret put HURTZ_WEBHOOK_SECRET
```
...
HURTZ_LEAD_WEBHOOK_URL=https://crm.hurtzcompany.com.br/webhooks/lead_forms/kVKxfWju8fYi8CXArWTwkP1B
